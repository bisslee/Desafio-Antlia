...
{
    public class ChangeManualMovementValidator : AbstractValidator<ChangeManualMovementRequest>
    {
        public ChangeManualMovementValidator()
        {
            RuleFor(x => x.Id)
                .NotEmpty()
                .WithMessage("Manual movement ID is required");
